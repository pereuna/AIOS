...
Hakemiston `model.bin` on valmis 73,35 MiB:n SMOLQ4-malli. Käännä UEFI-tiedosto:
...
GNU/Linuxissa tarvitaan GCC, binutils, GNU Make ja Python 3. GNU-EFI löytyy joko
